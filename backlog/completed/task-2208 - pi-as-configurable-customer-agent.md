---
id: TASK-2208
title: pi as configurable customer agent
status: done
assignee: [claude]
created_date: '2026-07-10 08:44'
labels: [user_value]
dependencies: []
---
...
ensure Forgejo token discovery still works for missions drafted from non-primary feature branches, so the mission worktree can reuse the same review credentials a normal `../parallix`-started mission gets
