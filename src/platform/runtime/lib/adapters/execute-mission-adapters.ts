 ...
 *
 * The command modules import the composition root, which imports this module.
 * Resolving the command exports when the ports are actually built (rather than
 * at module scope) keeps that circular module graph from capturing
 * uninitialized helper bindings.
 */
