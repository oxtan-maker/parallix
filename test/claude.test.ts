...
const extractClaudeTelemetryFromStdoutModule = mockModule<typeof import('../src/adapters/agents/claude-telemetry.js')>('../src/adapters/agents/claude-telemetry.js', import.meta.url);
const claude = mockModule<typeof import('../src/adapters/agents/claude.js')>('../src/adapters/agents/claude.js', import.meta.url);
await installModuleMocks();
test.afterEach(() => mock.restoreAll());
const { resolveClaudeCommand } = resolveClaudeCommandModule;
const { extractClaudeSessionId } = extractClaudeSessionIdModule;
const { buildClaudeInvocation } = buildClaudeInvocationModule;
const { extractClaudeTelemetryFromStdout } = extractClaudeTelemetryFromStdoutModule;
