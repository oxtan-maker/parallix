...
exports.BUCKET_MEDIUM_MAX = exports.BUCKET_SMALL_MAX = exports.EXCLUSION_PATTERNS = void 0;
exports.classifyBucket = classifyBucket;
exports.isExcluded = isExcluded;
exports.computeNEL = computeNEL;
exports.computeNELRecord = computeNELRecord;
 ...
 */
exports.BUCKET_SMALL_MAX = 80;
exports.BUCKET_MEDIUM_MAX = 235;
/**
...
function classifyBucket(nel) {
    if (nel <= exports.BUCKET_SMALL_MAX) {
        return { label: 'Small', min: 0, max: exports.BUCKET_SMALL_MAX };
    }
    if (nel <= exports.BUCKET_MEDIUM_MAX) {
        return { label: 'Medium', min: exports.BUCKET_SMALL_MAX + 1, max: exports.BUCKET_MEDIUM_MAX };
    }
    return { label: 'Large', min: exports.BUCKET_MEDIUM_MAX + 1, max: Infinity };
}
/**
...
function isExcluded(filePath) {
    ...
    for (const pattern of exports.EXCLUSION_PATTERNS) {
...
function computeNEL(range, options = {}) {
    ...
    const result = (0, node_child_process_1.spawnSync)('git', ['diff', '--numstat', '-w', range], {
        cwd,
        encoding: 'utf8',
