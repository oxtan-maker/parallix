 ...
 */
function resolveReviewIdentity(slug, rootDir = process.cwd(), /** @type {{readReviewStateFn?: Function}} */ options = {}) {
...
/**
 * @typedef {{reviewer?: string, implementer?: string, round?: number, startedAt?: string, phase?: string, disposition?: string | null, reviewerRetryCount?: number, implementerRetryCount?: number, metadata?: {[key: string]: any}}} ReviewStateData
 */
...
class ReviewState {
   ...
   */
  constructor(slug, /** @type {ReviewStateData} */ data = {}) {
    const phaseInfo = normalizeReviewPhase(/** @type {string} */ (data.phase || ''), /** @type {string} */ (data.disposition || ''));
    this.slug = slug;
  ...
  transitionTo(nextPhase) {
    ...
    const transitions = /** @type {{[key: string]: string[]}} */ (PHASE_TRANSITIONS);
    const allowedArr = transitions[this.phase];
  ...
  /**
   * @returns {{reviewer?: string, implementer?: string, round?: number, startedAt?: string, phase?: string, disposition?: string, reviewerRetryCount?: number, implementerRetryCount?: number, metadata?: {[key: string]: any}}}
   */
  toJSON() {
    /** @type {{reviewer?: string, implementer?: string, round?: number, startedAt?: string, phase?: string, disposition?: string, reviewerRetryCount?: number, implementerRetryCount?: number, metadata?: {[key: string]: any}}} */
    const payload = {
