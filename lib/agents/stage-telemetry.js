...
exports.resolveStageTelemetry = resolveStageTelemetry;
...
function resolveStageTelemetry({ worktree, result, sinceMs = 0 } = {}) {
    ...
    try {
        const codexT = (0, codex_js_1.extractCodexTelemetry)((0, codex_js_1.codexHomeRoot)(worktree), { sinceMs: sinceMs || 0 });
