...
exports.SIGINT_SHORT_BLOCK_MINUTES = exports.DEFAULT_FALLBACK_HOURS = exports.PATTERN_SETS = void 0;
exports.detectLimitHit = detectLimitHit;
exports.parseResetTime = parseResetTime;
exports.formatBlockUntil = formatBlockUntil;
exports.ceilToNextHour = ceilToNextHour;
exports.findLimitHitMatch = findLimitHitMatch;
exports.clipContext = clipContext;
exports.parseIsoOffset = parseIsoOffset;
exports.parseIso = parseIso;
exports.parseTwelveHour = parseTwelveHour;
exports.parseTwentyFourHour = parseTwentyFourHour;
exports.parseRelative = parseRelative;
exports.parseRetryAfter = parseRetryAfter;
exports.parseRetryAtDate = parseRetryAtDate;
exports.projectClockTime = projectClockTime;
exports.getPatternsForAgent = getPatternsForAgent;
const DEFAULT_FALLBACK_HOURS = 1;
exports.DEFAULT_FALLBACK_HOURS = DEFAULT_FALLBACK_HOURS;
const SIGINT_SHORT_BLOCK_MINUTES = 15;
exports.SIGINT_SHORT_BLOCK_MINUTES = SIGINT_SHORT_BLOCK_MINUTES;
...
exports.PATTERN_SETS = PATTERN_SETS;
...
function detectLimitHit({ agent, stdout = '', stderr = '', status, signal, error, now = new Date() } = {}) {
    if (!agent) {
        return null;
    }
    ...
    const launcherFailed = error !== null && error !== undefined ||
