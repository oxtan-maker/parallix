...
exports.captureOpencodeExport = captureOpencodeExport;
...
function captureOpencodeExport(sessionId, opts = {}) {
    const { worktree, env, timeoutMs = 30000, maxBytes = 32 * 1024 * 1024, spawn = node_child_process_1.default.spawn, } = opts;
    return new Promise((resolve) => {
        ...
        const finish = (value) => {
            ...
            if (tmpFd !== null) {
                try {
                    node_fs_1.default.closeSync(tmpFd);
                }
        ...
        try {
            tmpPath = node_path_1.default.join(node_os_1.default.tmpdir(), `opencode-export-${process.pid}-${Date.now()}.json`);
            tmpFd = node_fs_1.default.openSync(tmpPath, 'w');
        }
        catch (e) {
            tmpFileError = e;
        }
        ...
        child.on('close', () => {
            ...
            try {
                content = node_fs_1.default.readFileSync(tmpPath, 'utf8');
            }
            catch (_) {
                finish(null);
                return;
