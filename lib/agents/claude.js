...
exports.extractClaudeTelemetryFromStdout = void 0;
exports.buildClaudeInvocation = buildClaudeInvocation;
exports.extractClaudeSessionId = extractClaudeSessionId;
exports.resolveClaudeCommand = resolveClaudeCommand;
exports.startClaudeAgent = startClaudeAgent;
...
function startClaudeAgent({ prompt, worktree, env, resume = false, sessionId = null, model = null, teeOptions = {}, slug = null, role = null }) {
    ...
    function processResult(result) {
        if (result && result.stdout) {
            ...
            try {
                const telemetry = (0, claude_telemetry_js_1.extractClaudeTelemetryFromStdout)(result.stdout);
                if (telemetry) {
