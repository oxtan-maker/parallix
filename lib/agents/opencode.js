...
exports.buildOpencodeInvocation = buildOpencodeInvocation;
exports.extractOpencodeSessionId = extractOpencodeSessionId;
exports.resolveOpencodeCommand = resolveOpencodeCommand;
exports.startOpencodeAgent = startOpencodeAgent;
exports.isSpuriousOpencodeExit = isSpuriousOpencodeExit;
exports.isTransientOpencodeFailure = isTransientOpencodeFailure;
exports.isHardOpencodeFailure = isHardOpencodeFailure;
exports.shouldRetryOpencodeFailure = shouldRetryOpencodeFailure;
exports.__setSpawnAndTeeForTest = __setSpawnAndTeeForTest;
exports.__setExportCaptureForTest = __setExportCaptureForTest;
exports.__setSessionsForTest = __setSessionsForTest;
exports.__setJsonFormatSupportForTest = __setJsonFormatSupportForTest;
exports.__setJsonFormatDetectForTest = __setJsonFormatDetectForTest;
...
function __setExportCaptureForTest(fn) { _captureExport = fn || opencode_export_js_1.captureOpencodeExport; }
...
function opencodeCommandCandidates() {
    ...
    pushCandidate(node_path_1.default.join(node_os_1.default.homedir(), '.opencode', 'bin', 'opencode'));
    pushCandidate(node_path_1.default.join(node_os_1.default.homedir(), '.local', 'bin', 'opencode'));
    return candidates;
}
...
function shouldRetryOpencodeFailure(result) {
    ...
    if ((0, limit_hit_js_1.detectLimitHit)({
        agent: 'custom',
    ...
    if (isHardOpencodeFailure(result)) {
        return false;
    }
    return isTransientOpencodeFailure(result);
}
function startOpencodeAgent({ prompt, worktree, env, resume = false, sessionId = null, model = null, teeOptions = {}, slug = null, role = null, maxTransientRetries = 1 }) {
    ...
    async function processResult(result) {
        ...
        if (result && result.sessionId) {
            try {
                ...
                if (exportJson) {
                    const telemetry = (0, opencode_telemetry_js_1.extractOpencodeTelemetryFromExport)(exportJson, model || undefined);
                    if (telemetry) {
