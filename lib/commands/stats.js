 ...
 */
function telemetryToStatsFields(telemetry, { agentFamily, durationMinutes = 0, model } = {}) {
...
function recordActiveStats({ stage = 'active', slug, rootDir = process.cwd(), prFixRounds, model, ...rest } = {}) {
...
function recordReviewStats({ stage = 'review', slug, rootDir = process.cwd(), reviewer, implementer, prFixRounds, model, ...rest } = {}) {
