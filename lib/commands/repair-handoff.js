...
` +
        `- file:line references such as "lib/commands/handoff.ts:292"
` +
...
/** @param {string} file */
function isRepoLocalImplementationPath(file) {
...
async function repairHandoff(slug, worktree, errorMsg, options = {}) {
    ...
    if (isGitBlocker) {
        ...
        if (statusResult.status === 0 && statusResult.stdout) {
            ...
            const isSafeToCommit = (/** @type{string} */ file) => missionUtils.isMissionArtifact(file, slug, rootDir)
